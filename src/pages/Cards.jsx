...
export const Cards = () => {
  ...
  return (
    <div className="animate-fade-in flex flex-col gap-6 w-full max-w-6xl mx-auto p-4 h-full relative">
      <div className="w-full flex justify-between items-center bg-bg-secondary border border-glass rounded-xl p-5 shadow-sm z-10 w-full mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
        ...
        <div className="card p-6 border border-glass shadow-sm flex flex-col gap-6 w-full">
           ...
           <form onSubmit={handleSaveNewCard} className="flex flex-col gap-5">
              ...
              <div className="mt-4">
                <button type="submit" className="btn btn-primary w-full justify-center py-3.5 text-sm md:text-base font-bold flex items-center gap-2" style={{ background: 'var(--accent-primary)' }}>
